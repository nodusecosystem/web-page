...
import { BUDGET_OPTIONS, BUSINESS_HOURS, EMPTY_CONTACT_FORM } from '@/lib/constants/contact'
import { SERVICES } from '@/lib/constants/services'
import { CONTACT_CITY, CONTACT_COUNTRY, CONTACT_EMAIL, CONTACT_PHONE, RESPONSE_TIME } from '@/lib/constants/site'
...
export function ContactForm({
  ...
  subheading = 'Cuéntanos dónde está tu negocio hoy y dónde quieres llegar. Te proponemos un plan mensual claro, con objetivos medibles y sin permanencia.',
}: ContactFormProps) {
    ...
    <Section id="contacto" className="relative overflow-hidden bg-navy text-white">
      ...
      <Container className="relative grid gap-14 lg:grid-cols-2 lg:gap-16">
        <div className="flex flex-col items-start gap-6">
          <Badge className="bg-white/10 text-turquoise">Contacto</Badge>
          <h2 className="font-display text-3xl font-bold tracking-tight sm:text-4xl">
            {heading}
          </h2>
          <p className="max-w-md text-lg leading-relaxed text-white/70">{subheading}</p>
          <ul className="flex flex-col gap-5">
            ...
            <li className="flex items-center gap-3 text-white/80">
              ...
              {CONTACT_CITY}, {CONTACT_COUNTRY} · Atención 100% remota
            </li>
            <li>
          ...
          {status === 'success' ? (
            ...
            <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-5">
              ...
              <Textarea
                id="message"
                label="Mensaje"
                placeholder="Cuéntanos tu proyecto, tus objetivos y tu situación actual..."
