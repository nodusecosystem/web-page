...
import { useRef, useEffect, type CSSProperties, type ReactNode, type MouseEventHandler, type Ref } from 'react';
...
const SpecularButton = ({
  ...
  useEffect(() => {
    ...
    const renderer = (() => {
      try {
        return new Renderer({ alpha: true, premultipliedAlpha: true, antialias: true, dpr });
      } catch {
        return null;
      }
    })();
